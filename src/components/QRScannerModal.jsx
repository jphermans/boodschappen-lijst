  ...
  return (
    ...
    >
      <motion.div
        ...
        className="bg-[rgb(var(--card-bg))] rounded-2xl shadow-xl max-w-md w-full max-h-[calc(100vh-88px)] overflow-hidden mt-0"
        onClick={(e) => e.stopPropagation()}
      >
        <div className="flex items-center justify-between p-6 border-b border-[rgb(var(--border-color))]/20">
          <div className="flex items-center space-x-3">
            <div className="w-10 h-10 bg-[rgb(var(--primary-color))]/20 rounded-xl flex items-center justify-center">
              <Scan className="w-5 h-5 text-[rgb(var(--primary-color))]" />
            </div>
            ...
            <div className="space-y-4">
              {error ? (
                <div className="text-center py-8">
                  <div className="w-16 h-16 bg-[rgb(var(--error-color))]/20 rounded-full flex items-center justify-center mx-auto mb-4">
                    <AlertCircle className="w-8 h-8 text-[rgb(var(--error-color))]" />
                  </div>
                    ...
                    <div className="absolute inset-0 pointer-events-none">
                      <div className="absolute inset-4 border-2 border-white/30 rounded-2xl">
                        <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-48 h-48 border-2 border-white rounded-xl">
                          {/* Corner indicators */}
                          <div className="absolute -top-1 -left-1 w-6 h-6 border-t-4 border-l-4 border-[rgb(var(--primary-color))] rounded-tl-lg"></div>
                          <div className="absolute -top-1 -right-1 w-6 h-6 border-t-4 border-r-4 border-[rgb(var(--primary-color))] rounded-tr-lg"></div>
                          <div className="absolute -bottom-1 -left-1 w-6 h-6 border-b-4 border-l-4 border-[rgb(var(--primary-color))] rounded-bl-lg"></div>
                          <div className="absolute -bottom-1 -right-1 w-6 h-6 border-b-4 border-r-4 border-[rgb(var(--primary-color))] rounded-br-lg"></div>
                        </div>
                      </div>
                    </div>
                    ...
                    {!cameraReady && (
                      <div className="absolute inset-0 bg-black/50 flex items-center justify-center">
                        <div className="bg-white rounded-xl px-4 py-2 flex items-center space-x-2">
                          <div className="w-4 h-4 border-2 border-[rgb(var(--primary-color))] border-t-transparent rounded-full animate-spin"></div>
            ...
            <div className="space-y-6">
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-4 border border-[rgb(var(--border-color))]/30 rounded-xl focus:outline-none focus:ring-2 focus:ring-[rgb(var(--primary-color))] focus:border-transparent bg-[rgb(var(--card-bg))] text-[rgb(var(--card-text))] placeholder-[rgb(var(--text-color))]/40 transition-all duration-200"
                />
              </div>
