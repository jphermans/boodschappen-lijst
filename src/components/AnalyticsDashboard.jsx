      ...
      >
        ...
        <div className="flex items-center justify-between p-6 border-b border-[rgb(var(--border-color))]/50">
          <div className="flex items-center space-x-3">
            ...
            <div>
              ...
              <p className="text-sm text-[rgb(var(--text-color))]/60 ipad-simple-fix">
        ...
        <div className="flex-shrink-0 border-t border-[rgb(var(--border-color))]/50 p-6">
          <div className="flex items-center justify-between">
            ...
            <button
              onClick={onClose}
              className="px-4 py-2 bg-[rgb(var(--color-primary-button))] hover:opacity-90 text-white rounded-lg transition-colors"
            >
              Sluiten
            </button>
          </div>
