...
import { ArrowLeft, Palette, Moon, Sun, Link2, BarChart3, Settings } from 'lucide-react';
      ...
      <main className="max-w-4xl mx-auto px-4 lg:px-8 xl:px-12 py-6 lg:py-8 xl:py-12 safe-area-x content-safe-area" style={{ paddingTop: 'calc(var(--header-height) + 1.5rem)' }}>
        <div className="space-y-8">
              ...
              <div className="bg-[rgb(var(--border-color))]/10 p-4 rounded-lg">
                <div className="flex items-center justify-between">
                  ...
                  <button
                    ...
                    className="flex items-center space-x-2 px-4 py-2 bg-gradient-to-r from-primary to-secondary hover:opacity-90 text-white rounded-lg shadow-md hover:shadow-lg transform hover:scale-105 transition-all duration-200"
                  >
          ...
          >
            ...
            <div className="space-y-6">
              <div>
                <label className="block text-sm font-medium text-[rgb(var(--text-color))]/80 mb-3">
                  Primaire kleur
                </label>
                ...
                <input
                  ...
                  className="w-full h-12 rounded-lg cursor-pointer border border-[rgb(var(--border-color))]"
                />
              </div>
