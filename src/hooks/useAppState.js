...
export function useAppState() {
  ...
  // App state actions with error handling - moved useCallback to top level
  ...
  const navigateToList = useCallback((list) => {
    try {
  ...
  const setNewListName = useCallback((name) => {
    try {
  ...
  const clearNewListName = useCallback(() => {
    try {
  ...
  const optimisticListCreateStart = useCallback((name) => {
    try {
  ...
  const optimisticListCreateSuccess = useCallback(() => {
    try {
  ...
  const optimisticListCreateFailure = useCallback((error) => {
    try {
  ...
  // List state actions with error handling - moved useCallback to top level
  ...
  const setListsLoading = useCallback((isLoading) => {
    try {
  ...
  const setListsError = useCallback((error) => {
    try {
  ...
  const clearListsError = useCallback(() => {
    try {
  ...
  const optimisticAddList = useCallback((listData) => {
    try {
  ...
  const optimisticUpdateList = useCallback((listId, updates) => {
    try {
  ...
  const optimisticRemoveList = useCallback((listId) => {
    try {
  ...
  const revertOptimisticAdd = useCallback((tempId) => {
    try {
  ...
  const revertOptimisticUpdate = useCallback((listId) => {
    try {
  ...
  const revertOptimisticRemove = useCallback((listId) => {
    try {
  ...
  const updateItemInList = useCallback((listId, itemId, updates) => {
    try {
  ...
  const removeItemFromList = useCallback((listId, itemId) => {
    try {
  ...
  const toggleItemInList = useCallback((listId, itemId) => {
    try {
  ...
  // Utility functions - moved useCallback hooks to top level to avoid nesting
  ...
  const utilities = useMemo(() => ({
    ...
    getStorageInfo,
    getDebugInfo
  }), [exportState, importState, clearPersistedState, getStorageInfo, getDebugInfo]);
